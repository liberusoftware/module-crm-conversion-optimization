...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-conversion-optimization?sort=semver)](https://github.com/liberusoftware/module-crm-conversion-optimization/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-conversion-optimization/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-conversion-optimization/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-conversion-optimization
```
...
<a href="https://github.com/liberusoftware/module-crm-conversion-optimization/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-conversion-optimization" alt="Contributors to liberusoftware/module-crm-conversion-optimization">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-conversion-optimization/graphs/contributors).
